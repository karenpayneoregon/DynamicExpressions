...
Public Class EntityCrawler
    ...
    Public Property EnitityModelName() As String
    ''' <summary>
    ...
    Public Sub New(ByVal entityModelName As String)
    ...
    Public Sub GetInformation()
        ...
        For Each tableName As String In TableNames
            ...
            Dim temp = GetColumnInformation(tableName)
            ...
            TableInformation.Add(New TableInformation() With {.TableName = tableName, .Columns = columnNames, .PrimaryKeyList = keyNames, .EntityColumnList = temp})
    ...
    Public Function GetColumnInformation(ByVal tableName As String) As List(Of EntityColumn)
        ...
        '             * edmx: store
        '             
        Dim metaData = (_entityTypesData.Where(Function(entityType) entityType.FullName = $"{EnitityModelName}.{tableName}").Select(Function(entityTypesData) entityTypesData.DeclaredProperties)).ToList()
